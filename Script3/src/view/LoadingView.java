...
public class LoadingView extends JFrame {
	...
	private LoadDataToDw loadDataToDw;

	public LoadingView() {
		loadDataToDw = new LoadDataToDw();
		...
		jlblNotify = new JLabel("Loading data to db dw...");
		...
		switch (loadDataToDw.loadDataToDw()) {
		case -1:
			error();
			break;
		case 0:
